...
const NoticeBoardDetail = ({ isOpen, onClose }) => {
  ...
  return (
    <div>
      <Drawer id="notice-detail-drawer" open={isOpen} handleClose={onClose} title="안내판 상세" btns={drawerButtons}>
        <div>
          {/* Drawer 내부 컨텐츠 */}
                          ...
                          <table>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <SelectBasic placeholder="포맥스" />
                                </td>
                                <td>
                                  <Input className="grow" value="500*500" />
                                </td>
                                <td>
