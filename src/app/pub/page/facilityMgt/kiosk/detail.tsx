...
const KioskDetail = ({ isOpen, onClose }) => {
    ...
    const [images, setImages] = useState<ImageItem[]>([
        { url: "/images/test/img_thumb.png", name: "설치사진1" },
        { url: "/images/test/img_thumb.png", name: "설치사진2" },
        { url: "/images/test/img_thumb.png", name: "설치사진3" },
    ]);

    return (
        <div>
            <Drawer
                id="kiosk-detail-drawer"
                open={isOpen}
                handleClose={onClose}
                title="키오스크 상세"
                btns={drawerButtons}
                            ...
                            <table>
                                ...
                                <tbody>
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <div className="flex items-stretch items-center gap-2 w-full">
                                                    <Input
                                                        ...
                                                        readOnly
                                                        value="999999/ 강남 스마트공유 주차장 1-01"
                                                    />
                                                    <Button
                                                        type="outline"
                                                        size="m"
                                    ...
                                    <tr>
                                        <th>설치사진</th>
                                        <td>
                                            <div className="inline-flex flex-wrap items-center gap-[0.8125rem] pb-3 mt-3 pr-3">
                                                {images.map((image, index) => (
                                                    <div
                                                        ...
                                                        onClick={openModal} // 이미지 클릭시 모달 오픈
                                                    >
                                                        <Image
                                                            src={image.url}
                                                            alt={image.name}
                                                ...
                                                <FileDrop files={files} onFileChange={handleFileChange} />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
